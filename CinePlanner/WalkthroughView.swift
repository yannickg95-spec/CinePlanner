...
struct WalkthroughView: View {
    ...
    private let steps: [Step] = [
        ...
        Step(symbol: "clock.arrow.circlepath", tint: .teal,
             title: "Your work is safe",
             detail: "CinePlanner snapshots your data every time it launches. Use “Restore from Backup” any time to roll back to an earlier snapshot."),
    ]
