...
/// The app-wide default credit names, kept in UserDefaults (so the
/// `@AppStorage`-backed UI stays reactive) and synced across the user's devices
/// by SettingsSync. Read at project/episode creation to pre-fill.
enum CreditDefaults {
